...
$output = ob_get_clean();
check(strpos($output, '.column-title { width: 30%; }') !== false, 'Title column keeps a wide desktop share');
check(strpos($output, '.column-rank_math_seo_details { width: 18%; }') !== false, 'Rank Math SEO details gets enough desktop width');
